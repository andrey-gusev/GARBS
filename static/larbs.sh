...
dotfilesrepo="https://github.com/andrey-gusev/voidrice.git"
progsfile="https://raw.githubusercontent.com/andrey-gusev/GARBS/refs/heads/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
